...
CREATE TABLE IF NOT EXISTS `sy_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单';

-- 正在导出表  shiyu.sy_menu 的数据：~15 rows (大约)
INSERT INTO `sy_menu` (`id`, `create_time`, `update_time`, `parent_id`, `name`, `type`, `uri`, `code`, `icon`, `route_path`, `component`, `layout`, `method`, `redirect`, `keep_alive`, `description`, `sort`, `status`, `del_status`) VALUES
	(1, '2024-11-16 20:23:06', '2024-11-16 20:29:46', 0, '系统管理', 'MENU', '', 'SysMgt', 'i-fe:grid', '', '', '', '', NULL, NULL, '', 2, 0, 1),
	(2, '2024-11-16 20:27:19', '2024-11-16 20:27:19', 0, '个人资料', 'MENU', '', 'UserProfile', 'i-fe:user', '/profile', '/src/views/profile/index.vue', '', '', NULL, NULL, '', 99, 0, 1),
	(3, '2024-11-16 20:28:43', '2024-11-16 20:28:43', 0, '基础功能', 'MENU', '', 'Base', 'i-fe:grid', NULL, NULL, '', '', NULL, NULL, '', 0, 0, 1),
	(4, '2024-11-16 20:29:28', '2024-11-16 20:29:28', 0, '业务示例', 'MENU', '', 'Demo', 'i-fe:grid', NULL, NULL, '', '', NULL, NULL, '', 1, 0, 1),
	(5, '2024-11-16 20:31:52', '2024-11-16 20:31:52', 1, '资源管理', 'MENU', '', 'Resource_Mgt', 'i-fe:list', '/pms/resource', '/src/views/pms/resource/index.vue', '', '', NULL, NULL, '', 1, 0, 1),
	(6, '2024-11-16 20:32:37', '2024-11-16 20:54:14', 1, '角色管理', 'MENU', '', 'RoleMgt', 'i-fe:user-check', '/pms/role', '/src/views/pms/role/index.vue', '', '', NULL, 0, '', 2, 0, 1),
	(7, '2024-11-16 20:33:24', '2024-11-16 20:48:40', 1, '用户管理', 'MENU', '', 'UserMgt', 'i-fe:user', '/pms/user', '/src/views/pms/user/index.vue', '', '', NULL, 1, '', 3, 0, 1),
	(8, '2024-11-16 20:35:35', '2024-11-16 20:54:18', 6, '分配用户', 'MENU', '', 'RoleUser', 'i-fe:user-plus', '/pms/role/user/:roleId', '/src/views/pms/role/role-user.vue', 'full', '', NULL, 0, '', 1, 0, 1),
	(9, '2024-11-16 20:36:14', '2024-11-16 20:52:14', 7, '创建新用户', 'BUTTON', '', 'AddUser', 'i-fe:user-plus', '/pms/role/user/:roleId', '/src/views/pms/role/role-user.vue', '', '', NULL, 0, '', 1, 0, 1),
	(10, '2024-11-16 20:39:15', '2024-11-16 20:48:23', 4, '图片上传', 'MENU', '', 'ImgUpload', 'i-fe:image', '/demo/upload', '/src/views/demo/upload/index.vue', 'simple', '', NULL, 1, '', 1, 0, 1),
	(11, '2024-11-16 20:40:20', '2024-11-16 20:40:20', 3, '基础组件', 'MENU', '', 'BaseComponents', 'i-me:awesome', '/base/components', '/src/views/base/index.vue', 'simple', '', NULL, NULL, '', 1, 0, 1),
	(12, '2024-11-16 20:40:56', '2024-11-16 20:40:56', 3, 'Unocss', 'MENU', '', 'Unocss', 'i-me:awesome', '/base/unocss', '/src/views/base/unocss.vue', '', '', NULL, NULL, '', 2, 0, 1),
	(13, '2024-11-16 20:41:30', '2024-11-16 20:47:32', 3, 'KeepAlive', 'MENU', '', 'KeepAlive', 'i-me:awesome', '/base/keep-alive', '/src/views/base/keep-alive.vue', '', '', NULL, 1, '', 3, 0, 1),
	(14, '2024-11-16 20:42:14', '2024-11-16 20:47:05', 3, 'MeModal', 'MENU', '', 'TestModal', 'i-me:dialog', '/testModal', '/src/views/base/test-modal.vue', '', '', NULL, NULL, '', 4, 0, 1),
	(15, '2024-11-16 20:43:13', '2024-11-16 20:43:13', 3, '图标 Icon', 'MENU', '', 'Icon', 'i-fe:feather', '/base/icon', '/src/views/base/unocss-icon.vue', '', '', NULL, NULL, '', 0, 0, 1);
...
INSERT INTO `sy_role` (`id`, `create_time`, `update_time`, `name`, `code`, `permission_ids`, `status`, `del_status`) VALUES
	(1, '2024-11-16 19:33:15', '2024-11-16 19:33:15', 'SUPER_ADMIN', '超级管理员', NULL, 0, 1),
	(2, '2024-11-16 19:33:47', '2024-11-17 16:04:19', 'SYS_ADMIN', '系统管理员', NULL, 0, 1);
